...
export default function Contact() {
  ...
  const onSubmit = async (event) => {
    ...
    try {
      ...
      if (data.success) {
        alert("Pesan Anda berhasil dikirim! Kami akan menghubungi Anda dalam 24 jam.");
        navigate("/");
      } else {
      ...
      <section className="pt-24 pb-20 bg-gradient-to-r from-teal-600 to-blue-600 text-white relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          <p className="text-xl text-teal-100 max-w-3xl mx-auto leading-relaxed">
            Tim support kami siap membantu perjalanan belajar Anda. Dapatkan respons cepat 
            dan solusi tepat untuk semua pertanyaan seputar kursus dan platform.
          </p>
        </div>
      </section>
            ...
            <div className="lg:col-span-1 space-y-6">
              <div className="bg-white rounded-2xl shadow-xl p-8 border border-teal-100">
                ...
                <p className="text-gray-600 mb-8 leading-relaxed">
                  Butuh bantuan segera? Hubungi kami melalui berbagai channel yang tersedia. 
                  Tim kami siap membantu 24/7 untuk pertanyaan mendesak.
                </p>
                ...
                <div className="space-y-6">
                  {[
                    ...
                    },
                    {
                      icon: faEnvelope,
                      title: "Email Support",
                      details: ["support@educourse.id", "partnership@educourse.id"],
                    ...
                    },
                    {
                      ...
                      details: ["Jl. Digital Education No. 123", "Jakarta Selatan, 12560"],
                    ...
                    },
                    {
                      icon: faClock,
                      title: "Support Hours",
                      details: ["Senin - Jumat: 08:00 - 18:00", "Sabtu - Minggu: 09:00 - 15:00"],
                      color: "from-orange-500 to-red-500",
                      description: "Live chat available 24/7"
                    }
                  ].map((contact, index) => (
                    <div key={index} className="flex items-start space-x-4 p-4 rounded-xl bg-gradient-to-r from-teal-50 to-blue-50 border border-teal-100 group hover:shadow-lg transition-all duration-300">
                      <div className={`w-12 h-12 rounded-xl bg-gradient-to-r ${contact.color} flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform duration-300`}>
                        <FontAwesomeIcon icon={contact.icon} className="text-white text-lg" />
                      </div>
                      <div className="flex-1">
                        ...
                        <p className="text-teal-600 text-xs font-medium mt-2">{contact.description}</p>
                      </div>
                    </div>
                  ))}
                </div>
              ...
              <div className="bg-gradient-to-r from-teal-600 to-blue-600 rounded-2xl shadow-xl p-8 text-white">
                ...
                <p className="text-teal-100 mb-6 leading-relaxed">
                  Chat langsung dengan tim support kami untuk pertanyaan mendesak dan bantuan teknis.
                </p>
            ...
            <div className="lg:col-span-2">
              <div className="bg-white rounded-2xl shadow-xl p-8 lg:p-10 border border-teal-100">
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <h3 className="text-2xl font-bold text-gray-800">Kirim Pesan kepada Kami</h3>
                </div>
                <p className="text-gray-600 mb-8">Isi formulir di bawah ini dan kami akan segera menghubungi Anda dalam waktu 24 jam.</p>
                ...
                <form onSubmit={onSubmit} className="space-y-6">
                  ...
                  <div>
                    ...
                    >
                      ...
                      <option value="course-inquiry">
                        <FontAwesomeIcon icon={faGraduationCap} /> Pertanyaan Kursus
                      </option>
                      <option value="technical-support">
                        <FontAwesomeIcon icon={faHeadset} /> Bantuan Teknis
                      </option>
                      <option value="billing">
                        <FontAwesomeIcon icon={faCreditCard} /> Pertanyaan Pembayaran
                      </option>
                      <option value="partnership">
                        <FontAwesomeIcon icon={faHandshake} /> Kemitraan & Kerjasama
                      </option>
                      <option value="feedback">
                        <FontAwesomeIcon icon={faCommentDots} /> Masukan & Saran
                      </option>
                  ...
                  <div>
                    ...
                    <div className="flex gap-4">
                      {[
                        { value: "low", label: "Rutin", color: "bg-gray-100 text-gray-700" },
                        { value: "medium", label: "Standard", color: "bg-blue-100 text-blue-700" },
                        { value: "high", label: "Penting", color: "bg-orange-100 text-orange-700" },
                        ...
                        <label key={priority.value} className="flex items-center gap-2 cursor-pointer">
                          ...
                          />
                          <span className={`px-4 py-2 rounded-lg border-2 border-transparent peer-checked:border-teal-500 transition-all duration-200 ${priority.color} hover:shadow-md`}>
                            {priority.label}
                          </span>
                        </label>
                      ))}
                  ...
                  <div className="flex items-center gap-4 p-4 bg-teal-50 rounded-xl border border-teal-200">
                    ...
                    <div>
                      <p className="text-sm text-teal-700 font-medium">
                        Waktu Respons Rata-rata: 2-4 jam untuk pertanyaan mendesak
                      </p>
                    </div>
                  </div>
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl sm:text-4xl font-bold text-gray-800 mb-4">
              Pertanyaan yang <span className="text-teal-600">Sering Diajukan</span>
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Temukan jawaban cepat untuk pertanyaan umum seputar platform dan layanan kami
            </p>
          </div>
            ...
            {[
              {
                ...
                answer: "Gunakan fitur learning path advisor kami atau konsultasi gratis dengan education consultant untuk rekomendasi personal.",
                color: "from-purple-500 to-pink-500"
              },
              {
                icon: faCreditCard,
                question: "Apakah ada garansi refund?",
                answer: "Ya, kami menawarkan garansi uang kembali 30 hari jika kursus tidak sesuai ekspektasi. Syarat dan ketentuan berlaku.",
                color: "from-blue-500 to-teal-500"
              },
              {
                icon: faGraduationCap,
                question: "Apakah sertifikat diakui industri?",
                answer: "Semua sertifikat kami telah terverifikasi dan diakui oleh perusahaan partner kami di industri teknologi.",
                color: "from-green-500 to-teal-500"
              },
              {
                icon: faHandshake,
                question: "Apakah ada program beasiswa?",
                answer: "Kami menyediakan program beasiswa untuk pelajar berprestasi dan kebutuhan khusus. Daftar melalui halaman beasiswa.",
                color: "from-orange-500 to-red-500"
              },
              {
                icon: faHeadset,
                question: "Bagaimana cara akses support teknis?",
                answer: "Gunakan live chat 24/7, email support, atau booking technical support session dengan tim khusus kami.",
                color: "from-teal-500 to-blue-500"
              },
              {
                icon: faCommentDots,
                question: "Bisa konsultasi karir dengan mentor?",
                answer: "Ya, semua siswa premium mendapatkan akses 1-on-1 career consultation dengan mentor industri berpengalaman.",
              ...
              >
                <div className={`w-12 h-12 rounded-xl bg-gradient-to-r ${faq.color} flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300`}>
                  <FontAwesomeIcon icon={faq.icon} className="text-white text-lg" />
                </div>
